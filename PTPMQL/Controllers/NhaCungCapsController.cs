...
namespace PTPMQL.Controllers
{
    public class NhaCungCapsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaNCC,TenNCC,Address")] NhaCungCap nhaCungCap)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaNCC,TenNCC,Address")] NhaCungCap nhaCungCap)
        {
            if (ModelState.IsValid)
            {
